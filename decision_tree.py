...
def generateTree(dataset, features, feature_continuous):
	...
	if feature_continuous[best_feature_index]:
		...
		for node in children_nodes:
			root[split_feature][node] = generateTree(split_nominal(dataset, best_feature_index, node), features[:], feature_continuous[:])
...
if __name__ == "__main__":
	...
	# file_path = "/Users/jiemin/Documents/cmu/tasks/task11DataMining/trainProdSelection.arff"
